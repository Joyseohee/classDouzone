	...
	public static Connection getConnection(String dsn) {
		...
		try {
			if( dsn.equals("mysql") ) {
				...
				Class.forName("oracle.jdbc.OracleDriver");
				conn = DriverManager.getConnection("jdbc:oracle:thin:@kosadb_high?TNS_ADMIN=/Users/joy/Applications/Oracle/Wallet_kosaDB","user07", "xxxxxxAt22cc");
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
	...
	public static Connection getConnection(String dsn, String userid, String pwd) {
		...
		try {
			if( dsn.equals("mysql") ) {
				...
				Class.forName("oracle.jdbc.OracleDriver");
				conn = DriverManager.getConnection("jdbc:oracle:thin:@kosadb_high?TNS_ADMIN=/Users/joy/Applications/Oracle/Wallet_kosaDB",userid, pwd);
			}
		} catch (Exception e) {
			e.printStackTrace();
		} finally {
